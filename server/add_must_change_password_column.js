  ...
  try {
    ...
    if (checkAdminUsers.recordset[0].count === 0) {
      ...
      await pool.request().query(`
        ...
        ADD must_change_password BIT DEFAULT 0 NOT NULL
      `);
      console.log('✅ Added must_change_password to admin_users');
    } else {
      console.log('ℹ️  must_change_password column already exists in admin_users');
    }
    ...
    if (checkAdmins.recordset[0].count === 0) {
      ...
      await pool.request().query(`
        ...
        ADD must_change_password BIT DEFAULT 0 NOT NULL
      `);
      console.log('✅ Added must_change_password to admins');
    } else {
      console.log('ℹ️  must_change_password column already exists in admins');
    }
